setwd("~/Science/hess-2021-609/PartII.aggregation/datasets/Temperature_format")
...
list.main <- ctbi(data,bin.period='5 min',bin.center=as.POSIXct('2000-01-01 00:02:30'),k.outliers = Inf)
